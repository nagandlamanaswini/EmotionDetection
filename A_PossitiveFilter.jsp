  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	    ...
	    <h2><strong>View All Positive Tweets Details         </strong></h2>
	...
	<table width="572" border="1">
				  <tr>
				    <td colspan="5" ><h2><strong>Positive Tweets of :</strong> <%=s1%> [tweet owner: <a href="A_UserProfile.jsp?value=<%=s7%>&type=<%="positive"%>"> <%=s7%>] </a> </h2></td>
			      </tr>
				  <tr>
					<td width="174" height="40" bgcolor="#FFFF00" ><div align="left" class="style4 style5">
					...
					while ( rs1.next() )
			             ...
			             String t2=rs1.getString(2).toLowerCase();
			                 ...
			                 count1++;
									 %>
							  <tr>
								<td width="174" height="34"  style="color:#000000;"><div align="center"><a href="A_UserProfile.jsp?value=<%=s3%>&type=<%="positive"%>"><%=s3%></a></div></td>
								<td width="146" height="34"  style="color:#000000;"><div align="center"><%=s5%></div></td>
								<td width="128" height="34"  style="color:#000000;"><div align="center"><%=s4%></div></td>
								<td width="145" height="34"  style="color:#000000;"><div align="center">
