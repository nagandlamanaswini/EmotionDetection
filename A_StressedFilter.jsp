...
<head>
<title>All stressed tweets...</title>
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
	    ...
	    <h2><strong>View All Stressed Tweets Details         </strong></h2>
	...
	String s1="",s2="",s3="",s4="",s5="",s6="",s7="", pos="stress" ;
	...
	<table width="572" border="1">
				  <tr>
				    <td colspan="5" ><h2><strong>Stressed Tweets of :</strong> <%=s1%> [tweet owner: <a href="A_UserProfile.jsp?value=<%=s7%>&type=<%="stressed"%>"> <%=s7%>] </a> </h2></td>
			      </tr>
				  <tr>
					<td width="174" height="31" bgcolor="#FFFF00" ><div align="left" class="style4 style5">
					...
					while ( rs1.next() )
			             ...
			             String t2=rs1.getString(2).toLowerCase();
			                 ...
			                 count1++;
									 %>
							  <tr>
								<td width="174" height="39"  style="color:#000000;"><div align="center"><a href="A_UserProfile.jsp?value=<%=s3%>&type=<%="stressed"%>"> <%=s3%></a></div></td>
								<td width="146" height="39"  style="color:#000000;"><div align="center"><%=s5%></div></td>
								<td width="128" height="39"  style="color:#000000;"><div align="center"><%=s4%></div></td>
								<td width="145" height="39"  style="color:#000000;"><div align="center">
								<a href="details.jsp?tname=<%=s1%>&type=<%="stressed"%>"><strong>View&nbsp;</strong></a></div></td>
							  </tr>
	    ...
	    <%
					...
					ResultSet rs2=st2.executeQuery("select * from stressed where tname='"+s1+"' ");
			
					if(rs2.next()==true)
					{
						Statement st30=connection.createStatement();
						st30.executeUpdate("update stressed set totaluser='"+count+"', stressed='"+count1+"' where tname='"+s1+"' ");
						
					}
					else
					{
						Statement st30=connection.createStatement();
						st30.executeUpdate("insert into stressed (tname,totaluser,stressed)values('"+s1+"','"+count+"','"+count1+"')");
