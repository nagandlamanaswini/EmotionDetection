  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        ...
        <h2><em>Positive Emotion Analysis Results  </em></h2>
		 
             
			 
			 <iframe width="600" height="400" src="A_PosResult.jsp"></iframe>
            
            
            <p align="right" class="style2">&nbsp;</p>
            <p align="right" class="style2"><a href="A_Results.jsp">Back</a></p>
